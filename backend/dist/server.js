...
const arc_worker_1 = require("./engine/blockchain/arc.worker");
let server;
...
process.on('unhandledRejection', (error) => {
    logger_1.default.warn('Unhandled Rejection (ignored to prevent crash)', error);
});
process.on('SIGTERM', () => {
